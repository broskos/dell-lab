...
openstack network segment set --name central $uuid
openstack subnet create --network midhaul1-net --no-dhcp --network-segment central --subnet-range 192.168.205.0/26 --gateway 192.168.205.62 --dns-nameserver 172.17.118.8 midhaul1-subnet
openstack network segment create --network midhaul1-net --physical-network sriov-edge1-1 --network-type vlan --segment 1205  edge1
openstack subnet create --network midhaul1-net --no-dhcp --network-segment edge1 --subnet-range 192.168.205.64/26 --gateway 192.168.205.62 --dns-nameserver 172.17.118.8 mgmt-edge1-subnet
openstack network segment create --network midhaul1-net --physical-network sriov-edge2-1 --network-type vlan --segment 2205 edge2
openstack subnet create --network midhaul1-net --no-dhcp --network-segment edge2 --subnet-range 192.168.205.128/26 --gateway 192.168.205.126 --dns-nameserver 172.17.118.8 mgmt-edge2-subnet
...
openstack network segment set --name central $uuid
openstack subnet create --network midhaul2-net --no-dhcp --network-segment central --subnet-range 192.168.205.0/26 --gateway 192.168.205.62 --dns-nameserver 172.17.118.8 midhaul2-subnet
openstack network segment create --network midhaul2-net --physical-network sriov-edge1-2 --network-type vlan --segment 1205  edge1
openstack subnet create --network midhaul2-net --no-dhcp --network-segment edge1 --subnet-range 192.168.205.64/26 --gateway 192.168.205.62 --dns-nameserver 172.17.118.8 mgmt-edge1-subnet
openstack network segment create --network midhaul2-net --physical-network sriov-edge2-2 --network-type vlan --segment 2205 edge2
openstack subnet create --network midhaul2-net --no-dhcp --network-segment edge2 --subnet-range 192.168.205.128/26 --gateway 192.168.205.126 --dns-nameserver 172.17.118.8 mgmt-edge2-subnet
...
openstack network segment set --name edge1 $uuid
openstack subnet create --network fronthaul1-net --no-dhcp --network-segment edge1 --subnet-range 192.168.203.0/26 --gateway 192.168.203.62 --dns-nameserver 172.17.118.8 fronthaul1-subnet
openstack network segment create --network fronthaul1-net --physical-network sriov-edge2-1 --network-type vlan --segment 2203 edge2
openstack subnet create --network fronthaul1-net --no-dhcp --network-segment edge2 --subnet-range 192.168.203.128/26 --gateway 192.168.203.126 --dns-nameserver 172.17.118.8 mgmt-edge2-subnet
...
openstack network segment set --name edge1 $uuid
openstack subnet create --network fronthaul2-net --no-dhcp --network-segment edge1 --subnet-range 192.168.203.0/26 --gateway 192.168.203.62 --dns-nameserver 172.17.118.8 fronthaul2-subnet
openstack network segment create --network fronthaul2-net --physical-network sriov-edge2-2 --network-type vlan --segment 2203 edge2
openstack subnet create --network fronthaul2-net --no-dhcp --network-segment edge2 --subnet-range 192.168.203.128/26 --gateway 192.168.203.126 --dns-nameserver 172.17.118.8 mgmt-edge2-subnet
