...
openstack subnet create --project admin --network management-net --no-dhcp --subnet-range 172.17.117.0/24 --gateway 172.17.117.254 --allocation-pool start=172.17.117.5,end=172.17.117.100 --dns-nameserver 172.17.118.8 management-subnet
